  ...
  return (
    <div className="flex max-w-[170px] flex-col">
      <div className="flex items-center gap-[4px]">
        ...
        />
        <span className="text-regular12 w-full truncate">{feed.club.name}</span>
      </div>
      ...
      <div>
        <div className="text-bold14 mb-[3px] w-full truncate">{feed.title ? feed.title : feed.content}</div>
